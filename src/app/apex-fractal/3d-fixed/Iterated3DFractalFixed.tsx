...
function apexFractal3DFixed(
  ...
  function gen(
    ...
    for (let i = 0; i < 2; i++) {
      ...
      gen(M, childEnd, depth - 1, twist + twistStep, d, right);
    }
  }
...
export default function Iterated3DFractalFixed() {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.heading}>Apex fractal — iterated in 3D (fixed frame)</h1>
      ...
      <p className={styles.hint}>
        Twist 0° = flat, matches the 2D shape exactly — the branching frame is carried forward
        continuously from parent to child instead of being recomputed against a fixed axis.
        Drag the viewport to orbit; drag the dot to change scale/angle.
      </p>
    </div>
  );
}
